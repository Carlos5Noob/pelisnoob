...
export const getStaticProps = (async (context) => {
  const res = await fetch(`https://api.themoviedb.org/3/discover/movie?api_key=TU_API_KEY&language=es-ES&with_genres=18`.replace("TU_API_KEY", API_KEY || ""))
...
export default function Drama({
  ...
  return (
    ...
    >
      ...
      <h1 className="text-3xl sm:text-5xl font-bold text-center">Películas de Drama</h1>
      <Nav />
