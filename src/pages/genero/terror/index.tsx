...
export const getStaticProps = (async (context) => {
  const res = await fetch(`https://api.themoviedb.org/3/discover/movie?api_key=TU_API_KEY&language=es-ES&with_genres=27`.replace("TU_API_KEY", API_KEY || ""))
...
export default function Terror({
  ...
  return (
    ...
    >
      ...
      <h1 className="text-3xl sm:text-5xl font-bold text-center">Películas de Terror</h1>
      <Nav />
